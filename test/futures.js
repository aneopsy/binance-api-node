...
test('[FUTURES-REST] avgPrice', async t => {
...
test('[FUTURES-REST] Signed call without creds', async t => {
  try {
...
test('[FUTURES-REST] Signed call without creds - attempt getting tradeFee', async t => {
  try {
...
test('[FUTURES-REST] Server-side JSON error', async t => {
...
test('[FUTURES-REST] Server-side HTML error', async t => {
...
test('[FUTURES-WS] partial depth', t => {
  return new Promise(resolve => {
...
test('[FUTURES-WS] aggregate trades', t => {
  return new Promise(resolve => {
...
test('[FUTURES-REST] markPrice', async t => {
  const res = await client.futures.markPrice()
...
test('[FUTURES-REST] allForceOrders', async t => {
  const res = await client.futures.allForceOrders()
  t.truthy(Array.isArray(res))
...
test('[FUTURES-REST] fundingRate', async t => {
  const fundingRate = await client.futures.fundingRate({ symbol: 'BTCUSDT' })
